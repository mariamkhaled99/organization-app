...
MONGO_URL = os.getenv('DATABASE_URL','mongodb://mongo:vFhIqhLMNwwcrxOAOZrVVsVswigfFFLj@autorack.proxy.rlwy.net:58326/organization?retryWrites=true&w=majority&appName=organization-app&authSource=admin')
